...
void Add(){
    ...
    cout<<std::chrono::duration_cast<std::chrono::milliseconds>(addSerialEnd - addSerialBegin).count()<<" milliseconds"<<endl;
    ...
    cout<<std::chrono::duration_cast<std::chrono::milliseconds>(addThreadsEnd - addThreadsBegin).count()<<" milliseconds"<<endl;
...
void Multiply(){
    ...
    cout<<std::chrono::duration_cast<std::chrono::milliseconds>(multiplySerialEnd - multiplySerialBegin).count()<<" millseconds"<<endl;
    ...
    cout<<std::chrono::duration_cast<std::chrono::milliseconds>(multiplyThreadsEnd - multiplyThreadsBegin).count()<<" milliseconds"<<endl;
