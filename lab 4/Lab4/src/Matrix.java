...
public class Matrix extends Thread
{
    ...
    public Integer sum2(int i, int j, Matrix a, Matrix b) {
    ...
    public Integer prod2(int i, int j, Matrix a, Matrix b) {
    ...
    public void prod1(int i, Matrix a, Matrix b){
        ...
        if(i<a.getRowNo()) {
            //System.out.println("i.." + String.valueOf(i));
            //for (int k = i; k < a.getRowNo(); k += threads)
                for (int j = 0; j < b.getColumnNo(); j++) {
                    r = 0;
                    //System.out.println("second for");
                    for (int id = 0; id < a.getColumnNo(); id++) {
                        //System.out.println("wtf");
                        //System.out.println("i: " + String.valueOf(i) + ",id: " + String.valueOf(id) + ",j: " + String.valueOf(j));
                        //System.out.println("Matrix1: " + String.valueOf(a.getValues()[i][id]));
                        //System.out.println("Matrix2: " + String.valueOf(b.getValues()[i][id]));
                        r += a.getValues()[i][id] * b.getValues()[id][j];
                        //System.out.println("r" + String.valueOf(r));
                    }
                    this.setValues(i, j, r);
                }
        }
    }
